...
def render_home_refined_styles():
    ...
    st.html(
        ...
        :root {
            ...
            --pcr-home-shadow: 0 18px 48px rgba(11, 31, 58, 0.11);
        ...
        html, body, .stApp, .stAppViewContainer, .stMain {
            margin: 0 !important;
            padding: 0 !important;
        }
        ...
        .pcr-home-hero-refined {
            position: relative;
            overflow: hidden;
            min-height: clamp(620px, calc(100vh - 3.5rem), 820px);
            color: #F6FAFC;
            background:
